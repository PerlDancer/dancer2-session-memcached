...
Boolean (0|1), if Memcache cluster is not reachable and fatal_cluster_unreachable is set to 1, the application will croak

=for Pod::Coverage method_names_here

=for: stopwords cpan testmatrix URL annocpan Anno bug tracker rt cpants kwalitee diff IRC mailto metadata placeholders metacpan
